...
local function AddAllyCreep(_, unit)
 -- print('--------------------------------------------------')
  --print('TRY TO ADD ALLY CREEP')
  --print(unit:GetUnitName())
  --print(unit:GetHealth())
  --print(UNIT_TYPE["CREEP"])
  --print(GetTeam())
  --print('------------------------+++++++++++++++--------------------------')
...
function M.UpdateUnitList()
  ...
  --print(CURRENT_GAME_TIME,"THE CURRENT GAMETIME IS")
  local units = GetUnitList(UNIT_LIST_ALLIED_CREEPS)
  --for key, element in pairs(units) do
  --  print(key,"THE KEY")
  --  print(element,"THE ELEMENT")
  --  print(element:GetUnitName())
  --end  
